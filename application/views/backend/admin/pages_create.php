...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="#" class="active"><?php echo get_phrase('add_new_page'); ?></a> </li>
</ol>
<h2><i class="fa fa-arrow-circle-o-right"></i> <?php echo get_phrase('add_new_page'); ?></h2>
<br />
        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo get_phrase('add_new_page'); ?>
                </div>
            </div>
            <div class="panel-body">
                <form action="<?php echo site_url('panel-admin/pages/create'); ?>" method="post" role="form" class="padding10">
                    <div class="row">
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label class="text-bold"><?php echo get_phrase('title'); ?> <span class="red">*</span></label>
                            <input type="text" name="Pages[meta_title]" class="form-control" id="page-title" required>
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6 has-info">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="Pages[slug]" class="form-control" id="permalink" required>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 col-md-6">
                            ...
                            <input type="text" name="Pages[meta_keywords]" class="form-control">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <textarea name="Pages[meta_description]" class="form-control" required></textarea>
                        </div>
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <?php foreach ($statuses as $i => $status): ?>
                                <label class="radio-inline">
                                    <input type="radio" name="Pages[status]" value="<?php echo $status;?>" id="optionsRadios-<?php echo $i; ?>" <?php if ($i == 0): ?>checked="checked"<?php endif; ?>>
