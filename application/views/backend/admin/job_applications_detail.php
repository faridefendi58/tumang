        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">
                <table class="table table-bordered mt20" id="table-1">
                    ...
                    <tr>
                        <td><?php echo get_phrase('notes'); ?></td>
                        <td><?php echo $data->notes; ?></td>
                    </tr>
                    </tbody>
                </table>
                <a href="javascript:void(0);"
                   onclick="return removeApp(this);"
                   attr-href="<?php echo site_url('panel-admin/job-applications/delete/'. $data->id); ?>" attr-id="<?php echo $data->id;?>"
