...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="#" class="active"><?php echo get_phrase('create_new_category'); ?></a> </li>
</ol>
<h2><i class="fa fa-arrow-circle-o-right"></i> <?php echo get_phrase('create_new_category'); ?></h2>
<br />
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <form action="<?php echo site_url('panel-admin/categories/create'); ?>" method="post" role="form" class="padding10">
                    <div class="row">
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label class="text-bold"><?php echo get_phrase('title'); ?> <span class="red">*</span></label>
                            <input type="text" name="PostsCategory[title]" class="form-control" id="title" required>
                        </div>

                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label class="text-bold"><?php echo get_phrase('slug'); ?> <span class="red">*</span></label>
                            <input type="text" name="PostsCategory[slug]" class="form-control" id="slug" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            ...
                            <textarea name="PostsCategory[description]" class="form-control"></textarea>
                        </div>
                    </div>
