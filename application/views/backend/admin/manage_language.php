                                        ...
                                        <div class="tab-content" style="padding-top: 15px;">
                                                ...
                                                <div class="tab-pane active" id="edit" style="padding: 5px">
                                                    <div class="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            echo form_open(site_url('panel-admin/manage_language/update_phrase/'.$current_editing_language), array('id' => 'phrase_form'));
                                                            $count = 1;
                                                            $language_phrases   =   $this->db->query("SELECT `phrase_id` , `phrase` , `$current_editing_language` FROM `tbl_language`")->result_array();
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach($fields as $field)
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo site_url('panel-admin/manage_language/edit_phrase/'.$field);?>"
                                                                        class="btn btn-info">
                                                                        <?php echo get_phrase('edit_phrase');?>
                                                                    </a>
                                                                    <a href="<?php echo site_url('panel-admin/manage_language/delete_language/'.$field);?>"
                                            ...
                                            <div class="tab-pane box" id="add" style="padding: 5px">
                                                <div class="box-content">
                                                    <?php echo form_open(site_url('panel-admin/manage_language/add_phrase') , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                                                    <div class="padded">
                                            ...
                                            <div class="tab-pane box" id="add_lang" style="padding: 5px">
                                                <div class="box-content">
                                                    <?php echo form_open(site_url('panel-admin/manage_language/add_language'), array('class' => 'form-horizontal form-groups-bordered validate'));?>
                                                    <div class="padded">
                                                        <div class="form-group">
...
<script type="text/javascript">
	...
	function updatePhrase(phraseId) {
		...
		$.ajax({
			type : "POST",
			url  : "<?php echo site_url('panel-admin/update_phrase_with_ajax/'); ?>",
