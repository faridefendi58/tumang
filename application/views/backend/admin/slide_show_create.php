...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="#" class="active"><?php echo get_phrase('create_slide_show'); ?></a> </li>
</ol>
<h2><i class="fa fa-arrow-circle-o-right"></i> <?php echo get_phrase('create_slide_show'); ?></h2>
<br />
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <form action="<?php echo site_url('panel-admin/slide-show/create'); ?>" method="post" role="form" class="padding10" enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label class="text-bold"><?php echo get_phrase('title'); ?> <span class="red">*</span></label>
                            <input type="text" name="SlideShow[title]" class="form-control" id="title" required>
                        </div>

                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label class="text-bold"><?php echo get_phrase('sub_title'); ?> </label>
                            <input type="text" name="SlideShow[configs][subtitle]" class="form-control" id="sub-title">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input type="text" name="SlideShow[configs][button_label]" class="form-control" id="button-label">
                        </div>
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="SlideShow[url]" class="form-control" id="slug">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label class="text-bold"><?php echo get_phrase('order'); ?></label>
                            <input type="text" name="SlideShow[order]" class="form-control" id="slug">
                        </div>
                    </div>
