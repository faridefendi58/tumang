                ...
                <table class="table table-bordered datatable" id="table-1">
                    ...
                    foreach ($items as $item): ?>
                        <tr class= "<?php if( $counter % 2 == 0) echo 'odd gradeX'; else echo 'even gradeC'; $counter++;?>">
                            ...
                            <td>
                                <a href="<?php echo site_url('panel-admin/contacts/detail/'.$item['id']); ?>"><?php echo $item['name']; ?></a>
                            </td>
                            <td>
                                <?php echo $item['email']; ?>
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default" role="menu">
                                        <li>
                                            <a href="<?php echo site_url('panel-admin/contacts/detail/'.$item['id']); ?>">
                                                <?php echo get_phrase('detail');?>
                                            </a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="return removeContact(this);" attr-href="<?php echo site_url('panel-admin/contacts/delete/'. $item['id']); ?>" attr-id="<?php echo $item['id'];?>">
